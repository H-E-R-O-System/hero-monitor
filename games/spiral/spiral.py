...
class SpiralTest():
    ...
    def get_closest_coord(self, pos):
        pos_polar=pos - self.display_size / 2
        i = self.coord_count
        print("pos coords:",pos_polar)
        print("targ coords:", self.coords_polar[i])
        pos_angle=(np.arctan2(pos_polar[1], pos_polar[0]))
        print("pos:",pos_angle)
        targ_angle=(np.arctan2(self.coords_polar[i][1],self.coords_polar[i][0]))
        print("targ:",targ_angle)
    ...
    def create_surface(self, size=(800, 800)):
        ...
        return spiral_screen.base_surface, coords , coords_polar
...
if __name__ == "__main__":
    ...
    pg.init()
    spiral_test = SpiralTest(0.8, 5, (1000, 1000))
