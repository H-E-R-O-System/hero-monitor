# TODO: add frozen set and frozenset.union()
...
rightEyebrowIDs = [337, 296, 297, 335, 283, 284, 294, 277, 301]

leftEyebrowIDs = [108, 66, 67, 106, 53, 54, 64, 47, 71]

symLineIDs = [11, 152, 10, 9, 169, 7, 198, 196, 6, 5, 2, 20,
              95, 3, 165, 1, 12, 13, 14, 15, 16, 17, 18, 19, 201, 200, 176, 153]
...
keypointIDs = mouthIDs + eyeIDs + eyebrowIDs + cheekIDs + [5]
